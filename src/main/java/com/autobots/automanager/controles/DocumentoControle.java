...
public class DocumentoControle {
	...
	public ResponseEntity<?> cadastrarDocumento(@PathVariable long id, @RequestBody Documento atualizacao) {
		HttpStatus status = HttpStatus.CONFLICT;
		
		Documento alvo = repositorioDocumento.getById(atualizacao.getId());
		...
		if (alvo != null) {
			...
			repositorioDocumento.save(alvo);
